...
You can also install it directly by URL:
  ...
  return (
    <Field data-disabled={disabled ? true : undefined} data-invalid={fieldError ? true : undefined}>
      ...
      <div className="relative">
        {icon ? (
          <div className="text-muted-foreground inset-s-3 pointer-events-none absolute top-1/2 -translate-y-1/2">
            {icon}
          </div>
        ) : null}
        <Input
        ...
        {isPasswordField ? (
          <button
            ...
            disabled={disabled}
            className="text-muted-foreground hover:text-foreground inset-e-3 absolute top-1/2 -translate-y-1/2 transition-colors disabled:pointer-events-none disabled:opacity-50"
